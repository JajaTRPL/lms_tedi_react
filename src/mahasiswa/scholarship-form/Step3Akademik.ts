export const renderStep3Akademik = (formData: any, supportingDocumentsHtml = '') => `
    <div class="animate-enter-right space-y-8 pb-8">
        ...
        <div class="space-y-4">
            <div class="grid grid-cols-1 gap-2 sm:grid-cols-[200px_1fr] sm:items-center sm:gap-4">
            ...
            <div class="grid grid-cols-1 gap-2 sm:grid-cols-[200px_1fr] sm:items-start sm:gap-4">
                <label class="text-sm font-bold text-gray-800 sm:pt-2">SKSK (SKS Kumulatif)</label>
                <div class="space-y-1">
            ...
            <div class="grid grid-cols-1 gap-2 sm:grid-cols-[200px_1fr] sm:items-start sm:gap-4">
                <label class="text-sm font-bold text-gray-800 sm:pt-2">Jumlah Beban SKS untuk Lulus</label>
                <div class="space-y-1">
            ...
            <div class="grid grid-cols-1 gap-2 sm:grid-cols-[200px_1fr] sm:items-center sm:gap-4">
                ...
                <div class="flex flex-wrap items-center gap-4 sm:gap-6">
                    ...
                    <div id="leave-semester-container" class="flex-wrap ${formData.on_leave === 'Sudah' ? 'flex' : 'hidden'} items-center gap-2">
        ...
        <div id="history-section" class="${formData.has_scholarship_history === true || formData.has_scholarship_history == 1 ? 'block' : 'hidden'} space-y-6 pt-4 border-t border-gray-100">
            ...
            <div class="space-y-4">
                <div class="overflow-x-auto">
                    <table class="min-w-[820px] w-full text-left bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
