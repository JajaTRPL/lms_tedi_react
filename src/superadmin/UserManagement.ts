            ...
            : 'border-transparent text-gray-500 hover:text-gray-700'
                ...
                <div class="pb-3 relative ml-4" id="io-dropdown-wrapper">
                    ...
                    <div id="io-dropdown-menu" class="hidden absolute right-0 top-full mt-1 w-36 bg-white rounded-xl shadow-lg border border-gray-100 py-1 z-50">
                        <button id="export-btn" class="w-full text-left px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 hover:text-teal-700 transition-colors">Ekspor</button>
                        <button id="import-btn" class="w-full text-left px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 hover:text-teal-700 transition-colors">Impor</button>
                    </div>
                </div>
            </div>
