...
export const renderTendikDashboard = (role: string) => {
    ...
    const content = `
        <div class="space-y-6 animate-fade-in pb-12 w-full max-w-[1200px] mx-auto">
                        ...
                        <table class="w-full text-left bg-white">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ${Array(5).fill(0).map((_, i) => {
                                    ...
                                    const time = ["10.25", "12.25", "14.25", "07.25", "08.25"][i];
                                    const dateStr = i < 3 ? "24 Feb 2025" : "25 Feb 2025";
                                    const warningClass = i < 3 ? "" : "hidden";
                                    ...
                                    <tr class="hover:bg-gray-50/50 transition-colors">
                                        <td class="px-7 py-4 align-top">
                                            ...
                                            <p class="text-[10px] font-bold text-red-500 flex items-center gap-1 ${warningClass}"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg> 24 jam tertunda</p>
                                        </td>
            ...
            <!-- Pantauan Surat Berjalan Section -->
            <div class="mt-12">
                <div class="flex justify-end mb-2">
                    <a href="#" class="text-xs font-bold text-blue-500 hover:text-blue-700 transition-colors">Lihat Selengkapnya</a>
                </div>
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                    <div class="px-7 py-5 border-b border-gray-100 flex gap-3 items-start">
                        ...
                        <div>
                            <h2 class="text-[17px] font-bold text-gray-800">Pantauan Surat Berjalan</h2>
                            <p class="text-[11px] text-gray-500 mt-1">Daftar surat yang sedang diproses dan dapat Anda pantau statusnya</p>
                        </div>
                    </div>
                        ...
                        <table class="w-full text-left bg-white">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ${Array(5).fill(0).map((_, i) => {
                                    ...
                                    const noSurat = [
                                        "005/SPB/2026", "003/SRM/2026", "004/SPB/2026", "003/SRM/2026", "003/SPB/2026"
                                    ][i];
                                    const dateStr = i < 3 ? "Selasa, 24 Feb 2026" : "Senin, 23 Feb 2026";
                                    const jenis = ["Surat Beasiswa", "Surat Beasiswa", "Surat Magang", "Surat Magang", "Surat Beasiswa"][i];
                                    
                                    const statusVal = ["Diproses", "Ditolak", "Ditolak", "Selesai", "Selesai"][i];
                                    let statusBadge = "";
